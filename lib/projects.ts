...
export const projects: Project[] = [
  {
    ...
    status: 'Active',
    focus: 'Analogue front-end design, low-noise signal conditioning, dynamic light scattering',
    summary:
    ...
    tags: ['Electronics', 'Optics', 'Analogue Design'],
    featured: true,
    viewer: {
      provider: 'altium',
      title: 'DLS Analogue Front End Viewer',
